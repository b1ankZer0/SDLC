...
const appointmentApi = {
  getAppointmentRequests: async () => {
    const res = await callApi("/appointment/doctor/requests", "get");
    if (res.error) {
      throw new Error(res.message);
    }
    return res.data;
  ...
  approveAppointment: async (appointmentId) => {
    const res = await callApi(`/appointment/approve/${appointmentId}`, "put");
    if (res.error) {
      throw new Error(res.message);
    }
    return res.data;
  ...
  rejectAppointment: async (appointmentId) => {
    const res = await callApi(`/appointment/reject/${appointmentId}`, "put");
    if (res.error) {
      throw new Error(res.message);
    }
    return res.data;
